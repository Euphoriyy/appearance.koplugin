...
cp "$SCRIPT_DIR/LICENSE" "$SCRIPT_DIR/README.md" "$SCRIPT_DIR/main.lua" "$SCRIPT_DIR/_meta.lua" "$SCRIPT_DIR/themes.lua" "$SCRIPT_DIR/about.lua" "$WORK_DIR/appearance.koplugin/"
