...
theme_list.DEFAULT_NIGHT_THEMES = {
    ...
    { key = "french_blue",      label = "French Blue",      bg = "#003F91", fg = "#E5F4E3", night = true },
    -- Purple
    { key = "grape",            label = "Grape",            bg = "#474973", fg = "#F9F5E3", night = true },
    { key = "velvet",           label = "Velvet",           bg = "#532653", fg = "#F9D592", night = true },
